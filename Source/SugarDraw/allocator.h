...
typedef enum memory_tag {
    ...
    MEM_TAG_DIRECTDRAWCOLORCONTROL  = 7,
    MEM_TAG_IDIRECTDRAWCOLORCONTROL = 8,
    MEM_TAG_DIRECTDRAWPALETTE       = 9,
    MEM_TAG_IDIRECTDRAWPALETTE      = 10,
    MEM_TAG_DIRECTDRAWSURFACE       = 11,
    MEM_TAG_DIRECTDRAWSURFACEDATA   = 12,
    MEM_TAG_IDIRECTDRAWSURFACE      = 13,
    MEM_TAG_COUNT                   = 14,
